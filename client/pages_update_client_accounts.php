...
if (isset($_POST['update_account'])) {
    ...
    $query = "UPDATE  Web_bankAccounts  SET acc_name=?, account_number=?, acc_type=?, acc_rates=?, acc_status=?, acc_amount=?, client_name=?, client_national_id=?, client_phone=?, client_number=?, client_email=?, client_adr=? WHERE account_id =?";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <?php
        $account_id = $_GET['account_id'];
        $ret = "SELECT * FROM  Web_bankAccounts WHERE account_id = ? ";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update <?php echo $row->client_name; ?> Web_Based_Banking Account</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">Web_Based_Banking Accounts</a></li>
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    ...
                                                    <select class="form-control" onChange="getiBankAccs(this.value);" name="acc_type">
                                                        ...
                                                        $ret = "SELECT * FROM  Web_Acc_types ORDER BY RAND() ";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
                                                        $cnt = 1;
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="update_account" class="btn btn-success">Update Web_Based_Banking Account</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
